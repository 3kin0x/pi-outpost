...
- **1-Click LLM Workspace Synchronization**: The terminal detects current working directory (`pwd`) in real time. Clicking `🎯 Sync LLM` repositions the AI agent, file browser, and git view to that subdirectory.
